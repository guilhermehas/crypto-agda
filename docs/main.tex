...
The last verification, pCoinBaseFee, is a proof that if the transaction is a coinbase transaction,
so all miner output will be the total fee of previous transaction plus the miner reward.
