...
When two differrent blocks are created in nearly the same time, there are two valid blockchains.
...
It can be knowed calculating the sum amount of all unspent output transactions destined
for each address.
